    ...
    <>
      <ClientShell>
        ...
        >
          ...
          <p className="font-[family-name:var(--font-chakra)] text-lg md:text-xl text-[var(--color-txt-sec)] mb-5 opacity-0 animate-[fadeInUp_0.7s_ease_2.6s_forwards]">
            Technician &middot; Veteran &middot; Technical Problem Solver
          </p>

          <div className="flex flex-wrap gap-4 font-[family-name:var(--font-fira)] text-[12px] text-[var(--color-txt-sec)] mb-10 opacity-0 animate-[fadeInUp_0.7s_ease_2.7s_forwards]">
